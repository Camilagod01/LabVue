...
<template>  
    <div class="bg-white p-4 flex items-center">
        <input v-model ="message" @keypress.enter="sendMessage" type="text" placeholder="Type your message..."
         class="flex-1 border rounded-full px-4 py-2 focus:outline-none">
        <button @click="sendMessage"   class="bg-blue-500 text-white rounded-full p-2 ml-2
